...
fn serial_goldilock_crt_in_place(coefficients: &mut [Fq]) {
    ...
    // and zeta^5 = 1 - zeta.
    for i in 0..(D / 2) {
        let (coeff_i, coeff_d_div_2_plus_i) =
            (coefficients[i], coefficients[D / 2 + i]);
        let zeta_coeff_d_div_2_plus_i =
            ROOTS_OF_UNITY_24[4] * coeff_d_div_2_plus_i;

        coefficients[i] = coeff_i + zeta_coeff_d_div_2_plus_i;
        coefficients[i + D / 2] =
            coeff_i + coeff_d_div_2_plus_i - zeta_coeff_d_div_2_plus_i;
    }
    ...
    for i in 0..(D / 4) {
        // f_1
        {
            let (coeff_i, coeff_d_div_4_plus_i) =
                (coefficients[i], coefficients[D / 4 + i]);
            let sigma_coeff_d_div_4_plus_i =
                ROOTS_OF_UNITY_24[2] * coeff_d_div_4_plus_i;
        ...
        // f_2
        {
            ...
            let sigma_coeff_d_div_4_plus_i =
                ROOTS_OF_UNITY_24[10] * coeff_d_div_4_plus_i;
    ...
    for i in 0..(D / 8) {
        // f_1
        {
            let (coeff_i, coeff_d_div_8_plus_i) =
                (coefficients[i], coefficients[D / 8 + i]);
            let nonresidue_coeff_d_div_8_plus_i =
                ROOTS_OF_UNITY_24[1] * coeff_d_div_8_plus_i;
        ...
        // f_2
        {
            ...
            let sigma_coeff_d_div_8_plus_i =
                ROOTS_OF_UNITY_24[7] * coeff_d_div_8_plus_i;
        ...
        // f_3
        {
            ...
            let sigma_coeff_d_div_8_plus_i =
                ROOTS_OF_UNITY_24[5] * coeff_d_div_8_plus_i;
        ...
        // f_4
        {
            ...
            let sigma_coeff_d_div_8_plus_i =
                ROOTS_OF_UNITY_24[11] * coeff_d_div_8_plus_i;
...
fn serial_goldilock_icrt_in_place(evaluations: &mut [Fq]) {
    ...
    for i in 0..(D / 8) {
        ...
        {
            let (coeff_i, coeff_d_div_8_plus_i) =
                (evaluations[i], evaluations[D / 8 + i]);

            evaluations[i] = coeff_i + coeff_d_div_8_plus_i;
            evaluations[i + D / 8] =
                ROOTS_OF_UNITY_24[23] * (coeff_i - coeff_d_div_8_plus_i);
        }
        ...
        // f_2
        {
            ...
            evaluations[3 * D / 8 + i] =
                ROOTS_OF_UNITY_24[17] * (coeff_i - coeff_d_div_8_plus_i);
        }
        ...
        // f_3
        {
            ...
            evaluations[5 * D / 8 + i] =
                ROOTS_OF_UNITY_24[19] * (coeff_i - coeff_d_div_8_plus_i);
        }
        ...
        // f_4
        {
            ...
            evaluations[7 * D / 8 + i] =
                ROOTS_OF_UNITY_24[13] * (coeff_i - coeff_d_div_8_plus_i);
        }
    }
    ...
    for i in 0..(D / 4) {
        ...
        {
            let (coeff_i, coeff_d_div_4_plus_i) =
                (evaluations[i], evaluations[D / 4 + i]);

            evaluations[i] = coeff_i + coeff_d_div_4_plus_i;
            evaluations[i + D / 4] =
                ROOTS_OF_UNITY_24[22] * (coeff_i - coeff_d_div_4_plus_i);
        }
        ...
        // f_2
        {
            ...
            evaluations[3 * D / 4 + i] =
                ROOTS_OF_UNITY_24[14] * (coeff_i - coeff_d_div_4_plus_i);
        }
    }
    ...
    for i in 0..(D / 2) {
        ...
        let (coeff_i, coeff_d_div_2_plus_i) =
            (evaluations[i], evaluations[D / 2 + i]);
        let kappa_diff = KAPPA * (coeff_i - coeff_d_div_2_plus_i);

        evaluations[i] =
            EIGHT_INV * (coeff_i + coeff_d_div_2_plus_i - kappa_diff);
...
mod tests {
    ...
    fn test_roots_of_unity() {
        ...
        for i in 0..24u64 {
            assert_eq!(
                ROOTS_OF_UNITY_24[i as usize],
                ROOTS_OF_UNITY_24[1].pow([i])
            );
        }
    }
    ...
    fn test_crt_icrt() {
        let mut rng = ChaCha8Rng::seed_from_u64(0);
        let coefficients: Vec<Fq> =
            (0..24).map(|_| Fq::rand(&mut rng)).collect();
