...
impl Display for CyclotomicRingError {
    fn fmt(&self, f: &mut Formatter<'_>) -> FmtResult {
        match self {
            ...
            CyclotomicRingError::InvalidParameters(msg) => write!(f, "invalid parameters: {}", msg),
            CyclotomicRingError::IncompatibleModuli { modulus1, modulus2 } => write!(
                f,
                "incompatible moduli: {} vs {}",
                modulus1, modulus2
            ),
        }
    }
