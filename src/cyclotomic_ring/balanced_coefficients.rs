...
impl BalancedCoefficients {
    ...
    pub fn with_dimension(dimension: usize, modulus: i64) -> Result<Self> {
        ...
        let padded_dimension = dimension.div_ceil(SIMD_WIDTH) * SIMD_WIDTH;
        ...
        if coeffs.as_ptr() as usize % MEMORY_ALIGNMENT != 0 {
            ...
            let mut aligned_coeffs =
                Vec::with_capacity(padded_dimension + MEMORY_ALIGNMENT / 8);
    ...
    pub fn from_standard(
        ...
        RingConfig::validate_modulus(modulus)?;
