...
#[derive(From, Into)]
pub struct CyclotomicPolyRingGeneral<
...
impl<C: CyclotomicConfig<N>, const N: usize, const D: usize>
    CyclotomicPolyRingGeneral<C, N, D>
{
    pub(super) fn from_coeffs_vec(
        mut coeffs: Vec<Fp<C::BaseFieldConfig, N>>,
    ) -> Self {
    ...
    fn poly_mul(&self, rhs: &Self) -> Self {
        ...
        let mut coeffs = vec![
                <Fp::<C::BaseFieldConfig, N> as AdditiveGroup>::ZERO;
                2 * D - 1
            ];
...
const fn array_one<FP: FpConfig<N>, const N: usize, const D: usize>()
-> [Fp<FP, N>; D] {
...
impl<C: CyclotomicConfig<N>, const N: usize, const D: usize>
    CanonicalDeserialize for CyclotomicPolyRingGeneral<C, N, D>
{
    fn deserialize_with_mode<R: Read>(
        ...
        <[Fp<C::BaseFieldConfig, N>; D]>::deserialize_with_mode(
...
{
    const ZERO: Self =
        Self([<Fp<C::BaseFieldConfig, N> as AdditiveGroup>::ZERO; D]);
    const ONE: Self = Self(array_one());
}

impl<C: CyclotomicConfig<N>, const N: usize, const D: usize>
    FromRandomBytes<Self> for CyclotomicPolyRingGeneral<C, N, D>
{
    fn byte_size() -> usize {
...
impl<'a, C: CyclotomicConfig<N>, const N: usize, const D: usize>
    Add<&'a mut Self> for CyclotomicPolyRingGeneral<C, N, D>
{
    type Output = Self;
...
impl<'a, C: CyclotomicConfig<N>, const N: usize, const D: usize>
    Sub<&'a mut Self> for CyclotomicPolyRingGeneral<C, N, D>
{
    type Output = Self;
...
impl<'a, C: CyclotomicConfig<N>, const N: usize, const D: usize>
    Mul<&'a mut Self> for CyclotomicPolyRingGeneral<C, N, D>
{
    type Output = Self;
...
impl<'a, C: CyclotomicConfig<N>, const N: usize, const D: usize>
    MulUnchecked<&'a mut Self> for CyclotomicPolyRingGeneral<C, N, D>
{
    type Output = Self;
...
impl<'a, C: CyclotomicConfig<N>, const N: usize, const D: usize>
    AddAssign<&'a mut Self> for CyclotomicPolyRingGeneral<C, N, D>
{
...
impl<'a, C: CyclotomicConfig<N>, const N: usize, const D: usize>
    SubAssign<&'a mut Self> for CyclotomicPolyRingGeneral<C, N, D>
{
...
impl<'a, C: CyclotomicConfig<N>, const N: usize, const D: usize>
    MulAssign<&'a mut Self> for CyclotomicPolyRingGeneral<C, N, D>
{
...
impl<C: CyclotomicConfig<N>, const N: usize, const D: usize>
    Mul<Fp<C::BaseFieldConfig, N>> for CyclotomicPolyRingGeneral<C, N, D>
{
    type Output = Self;
...
impl<C: CyclotomicConfig<N>, const N: usize, const D: usize>
    MulUnchecked<Fp<C::BaseFieldConfig, N>>
    for CyclotomicPolyRingGeneral<C, N, D>
{
    type Output = Self;
...
macro_rules! impl_from_primitive_type {
    ($primitive_type: ty) => {
        impl<C: CyclotomicConfig<N>, const N: usize, const D: usize>
            From<$primitive_type> for CyclotomicPolyRingGeneral<C, N, D>
        {
...
impl<'a, C: CyclotomicConfig<N>, const N: usize, const D: usize>
    AddAssign<&'a Self> for CyclotomicPolyRingGeneral<C, N, D>
{
...
impl<'a, C: CyclotomicConfig<N>, const N: usize, const D: usize>
    SubAssign<&'a Self> for CyclotomicPolyRingGeneral<C, N, D>
{
...
impl<'a, C: CyclotomicConfig<N>, const N: usize, const D: usize>
    MulAssign<&'a Self> for CyclotomicPolyRingGeneral<C, N, D>
{
...
impl<'a, C: CyclotomicConfig<N>, const N: usize, const D: usize>
    Product<&'a Self> for CyclotomicPolyRingGeneral<C, N, D>
{
...
impl<C: CyclotomicConfig<N>, const N: usize, const D: usize>
    From<Vec<Fp<C::BaseFieldConfig, N>>>
    for CyclotomicPolyRingGeneral<C, N, D>
{
...
impl<C: CyclotomicConfig<N>, const N: usize, const D: usize>
    From<Fp<C::BaseFieldConfig, N>> for CyclotomicPolyRingGeneral<C, N, D>
{
    ...
    Fp<C::BaseFieldConfig, N>: Decompose,
{
    fn decompose_in_place(&self, b: u128, out: &mut [Self]) {
        ...
        for (i, coeff) in self.0.iter().enumerate() {
            ...
            out.iter_mut().zip(buffer.iter()).for_each(
                |(out_elem, &decomposed_coeff)| {
...
macro_rules! impl_add_mul_primitive_type {
    ($primitive_type: ty) => {
        impl<C: CyclotomicConfig<N>, const N: usize, const D: usize>
            Mul<$primitive_type> for CyclotomicPolyRingGeneral<C, N, D>
        {
            type Output = Self;
        ...
        impl<'a, C: CyclotomicConfig<N>, const N: usize, const D: usize>
            Mul<$primitive_type> for &'a CyclotomicPolyRingGeneral<C, N, D>
        {
        ...
        impl<C: CyclotomicConfig<N>, const N: usize, const D: usize>
            MulAssign<$primitive_type> for CyclotomicPolyRingGeneral<C, N, D>
        {
        ...
        impl<C: CyclotomicConfig<N>, const N: usize, const D: usize>
            Add<$primitive_type> for CyclotomicPolyRingGeneral<C, N, D>
        {
            type Output = Self;
        ...
        impl<'a, C: CyclotomicConfig<N>, const N: usize, const D: usize>
            Add<$primitive_type> for &'a CyclotomicPolyRingGeneral<C, N, D>
        {
            type Output = CyclotomicPolyRingGeneral<C, N, D>;
        ...
        impl<C: CyclotomicConfig<N>, const N: usize, const D: usize>
            AddAssign<$primitive_type> for CyclotomicPolyRingGeneral<C, N, D>
        {
        ...
        impl<C: CyclotomicConfig<N>, const N: usize, const D: usize>
            Sub<$primitive_type> for CyclotomicPolyRingGeneral<C, N, D>
        {
            type Output = Self;
        ...
        impl<'a, C: CyclotomicConfig<N>, const N: usize, const D: usize>
            Sub<$primitive_type> for &'a CyclotomicPolyRingGeneral<C, N, D>
        {
            type Output = CyclotomicPolyRingGeneral<C, N, D>;
