...
use derive_more::{
    Add, AddAssign, Display, Mul, MulAssign, Product, Sub, SubAssign, Sum,
};
use num_bigint::{BigInt, BigUint};
use num_integer::Integer;
use num_traits::{Num, sign::Signed};
...
impl<T: BitXor<Output = T>> BitXor<SignedRepresentative<T>>
    for SignedRepresentative<T>
{
    type Output = Self;
...
impl<T: BitXor<Output = T>> BitXor<UnsignedRepresentative<T>>
    for UnsignedRepresentative<T>
{
    type Output = Self;
